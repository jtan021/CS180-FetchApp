...
// Mutator of Name
void Bird::SetName(std::string& value)
{
	m_Name = value;
}

// Accessor of Gender
bool Bird::GetGender() const
{
	return m_Gender;
}

// Mutator of Gender
void Bird::SetGender(bool& value)
{
	m_Gender = value;
}
...
// Mutator of Height
void Bird::SetHeight(int& value)
{
	m_Height = value;
}

// Accessor of Weight
int Bird::GetWeight() const
{
	return m_Weight;
}

// Mutator of Weight
void Bird::SetWeight(int& value)
{
	m_Weight = value;
}
